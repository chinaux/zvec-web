...
> Zvec v0.7.0 聚焦「生态扩展、索引算法、部署体验、易用性」四大方向，核心亮点包括：全新的 **[zvec-grep](https://github.com/zvec-ai/zvec-grep)** 工作区搜索 CLI、**[ReMe](https://github.com/agentscope-ai/ReMe)** 集成、**IVF-RaBitQ** 索引、**DiskANN** 生产化（ARM64 + io_uring）、RaBitQ 运行时 **AVX2/AVX512** 分派、动态库体积 **缩减约 40%**、**musllinux** 支持、自动发布预构建 SDK、**DocIterator** 全集合遍历，以及 FTS **N-gram 分词器**。
>
